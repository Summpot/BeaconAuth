...
1. GitHub Releases から最新の MOD jar をダウンロードします。
   - 最新リリース: [GitHub Releases (latest)](https://github.com/Summpot/BeaconAuth/releases/latest)
