...
1. Téléchargez le dernier fichier jar depuis GitHub Releases.
   - Dernière version : [GitHub Releases (latest)](https://github.com/Summpot/BeaconAuth/releases/latest)
...
1. Téléchargez le même jar que sur le serveur.
   - Dernière version : [GitHub Releases (latest)](https://github.com/Summpot/BeaconAuth/releases/latest)
