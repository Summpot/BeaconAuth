...
loom {
    accessWidenerPath.set(project(":common-1.20.1").file("src/main/resources/beaconauth.accesswidener"))
...
tasks.processResources {
    ...
    from(project(":common-1.20.1").file("src/main/resources/beaconauth.accesswidener"))
