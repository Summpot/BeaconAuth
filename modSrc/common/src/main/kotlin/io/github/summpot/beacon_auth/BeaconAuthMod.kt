package io.github.summpot.beacon_auth

import dev.architectury.event.events.common.CommandRegistrationEvent
import io.github.summpot.beacon_auth.command.AuthCommand
import io.github.summpot.beacon_auth.event.AuthEventHandler
import org.slf4j.LoggerFactory

object BeaconAuthMod {
    const val MOD_ID = "beacon_auth"
    ...
    fun initClient() {
        ...
        io.github.summpot.beacon_auth.client.AuthClient.init()
    ...
    fun initServer() {
        ...
        io.github.summpot.beacon_auth.server.AuthServer.init()
