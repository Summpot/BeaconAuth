...
loom {
    accessWidenerPath.set(project(":common-1.21.8").file("src/main/resources/beaconauth.accesswidener"))
...
tasks.processResources {
    ...
    from(project(":common-1.21.8").file("src/main/resources/beaconauth.accesswidener"))
