...
/// Claims inside the signed Minecraft link ticket generated by the game server mod.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MinecraftLinkClaims {
    pub iss: String,
    pub sub: String,
    pub uuid: String,
    pub name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VerifyMinecraftTicketRequest {
    pub token: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VerifyMinecraftTicketResponse {
    pub uuid: String,
    pub username: String,
    pub expires_at: i64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ConfirmMinecraftLinkRequest {
    pub token: String,
}
...
mod tests {
    ...
    fn test_id_token_claims_serialization() {
        let claims = IdTokenClaims {
            ...
            identity_mode: Some("mojang".to_string()),
        };
        ...
        assert!(json.contains("069a79f4-44e9-4726-a5be-fca90e38aaf5"));
        assert!(json.contains("mojang"));
        ...
        assert_eq!(decoded.minecraft_uuid, claims.minecraft_uuid);
        assert_eq!(decoded.identity_mode, claims.identity_mode);
    }
}
